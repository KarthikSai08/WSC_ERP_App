...
namespace WSC.Delivery.Application.Interfaces.RepositoryInterfaces
{
    ...
    {
        Task<int> CreateDeliveryAsync(OrderDelivery delivery, CancellationToken ct);
        ...
        Task<IEnumerable<OrderDelivery>> GetByDeliveryStatusAsync(string sts, CancellationToken ct);
