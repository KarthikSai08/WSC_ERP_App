...
namespace WSC.Store.Application.Service
{
    public class OrderService : IOrderService
    {
        ...
        private readonly CustomerGrpcClientService _cstService;
        private readonly IMapper _mapper;


        public OrderService(IOrderRepository orderRepo, CustomerGrpcClientService cstService, IMapper mapper)
        {
        ...
        public async Task<ApiResponse<int>> CreateOrderAsync(CreateOrderDto dto, CancellationToken ct)
        {
            ...
            var customer = await _cstService.GetCustomerAsync(dto.CustomerId);
            if (customer == null)
